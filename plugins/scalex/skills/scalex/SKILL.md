...
Multi-step recipes for complex tasks. Read [workflows.md](references/workflows.md) for the full list:
...
When the user asks for a complex task, orchestrate these steps autonomously — don't ask for permission at each step.
